...
async def finish_game(session: AsyncSession, game: CubeGame, p1_result: int, p2_result: int) -> User:
...
async def handle_throw_timeout(session: AsyncSession, game_id: int, user_id: int, bet: Decimal) -> tuple[User, User, CubeGame | None]:
